    ...
    <div class="content">
        ...
        <div class="block">
            <div class="block-header">
                <h3 class="block-title">Listado @lang('generics.aptitudes')</h3>
                <div class="col-md-3 ml-auto text-right" style="padding: 1% 0;">
                    <a href="{{ route('aptitudes.create') }}">
    ...
    <script>
        $(document).ready(function () {
            $('#banks-table').DataTable({
                ...
                processing: true,
                responsive: true,
                ajax: "{{ route('aptitudes.get_list_data_tables') }}",
                columns: [
                    {name: 'id'},
                    {name: 'name'},
