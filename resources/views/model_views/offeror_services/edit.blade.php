...
@section('content')
    ...
    <!-- Page Content -->
    <div class="content">
        <h2>@lang('generics.edit_service')</h2>
        ...
        <div class="block">
            ...
            <div class="block-content">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-12 col-lg-12">
                        <div class="form-group">
                            ...
                            {!! Form::textarea('description',$offerorService->description,['class'=>'form-control', 'placeholder'=>__('generics.description'), 'required' => 'required']) !!}
                        </div>
                    </div>
                    <div class="col-xl-12 col-lg-12">
                        <div class="form-group">
                ...
                <div class="form-group text-right">
                    <a class="btn btn-secondary" href="/offeror_services/index/{{$offerorService->offeror_id}}">
