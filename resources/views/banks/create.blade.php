    ...
    <div class="content">
        ...
        <div class="block">
            <div class="block-header">
                <h3 class="block-title">Crear banco</h3>
            </div>

            <div class="block-content">
                {!! Form::open(['route'=>'banks.store', 'method'=>'POST', 'role' => 'form']) !!}
                    <div class="form-group">
                        {!! Form::label('name', __('generics.name')) !!}
                        {!! Form::text('name',old('name'),['class'=>'form-control', 'placeholder'=>'Nombre del banco', 'required' => 'required']) !!}
                    </div>
