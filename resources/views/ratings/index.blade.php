            ...
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                ...
                <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-alt">
                        <li class="breadcrumb-item">@lang('generics.ratings')</li>
                        <li class="breadcrumb-item" aria-current="page">
                            <a class="link-fx" href="{{route('ratings.index')}}">index</a>
                        </li>
                    </ol>
                </nav>
            </div>
    ...
    <div class="content">
        ...
        <div class="block">
            <div class="block-header">
                <h3 class="block-title">Listado @lang('generics.ratings')</h3>
            ...
            <div class="block-content">
                <table class="table table-vcenter" id="ratings-table">
                    <thead>
                    <tr>
                        <th>@lang('generics.rating')</th>
                        <th>@lang('generics.qualifier')</th>
                        <th>@lang('generics.qualified')</th>
                        <th>@lang('generics.comments')</th>
    ...
    <script>
        $(document).ready(function () {
            $('#ratings-table').DataTable({
                ...
                processing: true,
                responsive: true,
                ajax: "{{ route('ratings.get_list_data_tables') }}",
                columns: [
                    {name: 'rating'},
                    {name: 'qualifier'},
                    {name: 'qualified'},
