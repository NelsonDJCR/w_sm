            ...
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                ...
                <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-alt">
                        <li class="breadcrumb-item">@lang('generics.level')</li>
                        <li class="breadcrumb-item" aria-current="page">
                            <a class="link-fx" href="{{route('model-levels.index')}}">index</a>
                        </li>
                    </ol>
                </nav>
            </div>
    ...
    <div class="content">
        ...
        <div class="block">
            <div class="block-header">
                <h3 class="block-title">Listado @lang('generics.level')</h3>
                <div class="col-md-3 ml-auto text-right" style="padding: 1% 0;">
                    <a href="{{ route('model-levels.create') }}">
    ...
    <script>
        $(document).ready(function () {
            $('#banks-table').DataTable({
                ...
                processing: true,
                responsive: true,
                ajax: "{{ route('model_levels.get_list_data_tables') }}",
                columns: [
                    {name: 'id'},
                    {name: 'name'},
