        ...
        <div class="block">
            <div class="block-header">
                ...
                <div class="col-md-3 ml-auto text-right" style="padding: 1% 0;">
                    <a href="{{ route('monetary_requests.historic') }}">
                        <button type="button" class="btn bg-black">@lang('generics.transaction_history')</button>
                    </a>
                    <a href="{{ route('monetary_requests.create') }}">
                        <button type="button" class="btn btn-smirrow">@lang('generics.ask_money')</button>
                    </a>
                </div>
            </div>
            <!-- Your Block -->
            <table class="table table-bordered table-striped table-vcenter">
                <thead>
                <tr>
                    <th class="d-sm-table-cell">@lang('generics.status')</th>
                    <th class="d-sm-table-cell">@lang('generics.date')</th>
