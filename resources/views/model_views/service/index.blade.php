    ...
    <div class="content">
        ...
        <div class="block">
            <div class="block-header">
                <h3 class="block-title">Listado @lang('generics.services')</h3>
            ...
            <div class="block-content">
                <table class="table table-vcenter" id="services-table">
                    <thead>
                    <tr>
