            ...
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                ...
                <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-alt">
                        <li class="breadcrumb-item">@lang('generics.users')</li>
                        <li class="breadcrumb-item" aria-current="page">
                            <a class="link-fx" href="{{route('users.index')}}">index</a>
                        </li>
                    </ol>
                </nav>
            </div>
    ...
    <div class="content">
        ...
        <div class="block">
            <div class="block-header">
                <h3 class="block-title">Listado @lang('generics.users')</h3>
            ...
            <div class="block-content">
                <table class="table table-vcenter" id="users-table">
                    <thead>
                    <tr>
    ...
    <script>
        $(document).ready(function () {
            $('#users-table').DataTable({
                ...
                processing: true,
                responsive: true,
                ajax: "{{ route('users.get_list_data_tables') }}",
                columns: [
                    {name: 'id'},
                    {name: 'name'},
                    {name: 'email'},
