    ...
    <div class="content">
        ...
        <div class="block">
            <div class="block-header">
                <h3 class="block-title">Editar ciudad</h3>
            </div>
            ...
            <div class="block-content">
                ...
                {!! Form::open(['route'=>['departments.update',$department], 'method'=>'PUT', 'role' => 'form']) !!}
                <div class="form-group">
                    {!! Form::label('name', __('generics.name')) !!}
                    {!! Form::text('name',$department->name,['class'=>'form-control', 'placeholder'=>'Nombre de la ciudad', 'required' => 'required']) !!}
                </div>
                <div class="form-group">
                    {!! Form::label('country_id', __('generics.country')) !!}
                    {!! Form::select('country_id', $countries, $department->country_id, ['class'=>'form-control', 'placeholder'=>'Seleccione']) !!}
                </div>

                <div class="form-group">
                    <div class="custom-control custom-switch custom-control-lg mb-2">
                        {!! Form::checkbox('state',old('state'),$department->state, ['class'=>'custom-control-input', 'id'=>'state']) !!}
