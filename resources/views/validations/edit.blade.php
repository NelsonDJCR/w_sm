            ...
            <div class="block-content">
                ...
                <div class="form-group text-right">
                    @if ($offerorOrCustomer == 2)
                        <a class="btn btn-secondary" href="{{route('offerors.show', $user->offeror->id)}}#btabs-static-validations">
                            <i class="fa fa-times-circle"></i>
                            @lang('generics.cancel')
                        </a>
                    @else
                        <a class="btn btn-secondary" href="{{route('customers.show', $user->customer->id)}}#btabs-static-validations">
                            <i class="fa fa-times-circle"></i>
                            @lang('generics.cancel')
                        </a>
                    @endif
