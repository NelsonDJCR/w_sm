            ...
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                ...
                <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-alt">
                        <li class="breadcrumb-item">@lang('generics.offerors')</li>
                        <li class="breadcrumb-item" aria-current="page">
                            <a class="link-fx" href="{{route('offerors.index')}}">index</a>
                        </li>
                    </ol>
                </nav>
            </div>
    ...
    <div class="content">
        ...
        <div class="block">
            <div class="block-header">
                <h3 class="block-title">Listado @lang('generics.offerors')</h3>
            ...
            <div class="block-content">
                <table class="table table-vcenter" id="offerors-table">
                    <thead>
                    <tr>
                        <th>@lang('generics.user')</th>
                        <th>@lang('generics.gender')</th>
                        <th>@lang('generics.city')</th>
    ...
    <script>
        $(document).ready(function () {
            $('#offerors-table').DataTable({
                ...
                processing: true,
                responsive: true,
                ajax: "{{ route('offerors.get_list_data_tables') }}",
                columns: [
                    {name: 'nick'},
                    {name: 'gender'},
                    {name: 'city'},
