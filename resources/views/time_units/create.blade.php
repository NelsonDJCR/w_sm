    ...
    <div class="content">
        ...
        <div class="block">
            <div class="block-header">
                <h3 class="block-title">Crear Unidad de Tiempo</h3>
            </div>
            ...
            <div class="block-content">
                ...
                {!! Form::open(['route'=>'time_units.store', 'method'=>'POST', 'role' => 'form']) !!}
                <div class="form-group">
                    {!! Form::label('name', __('generics.name')) !!}
                    {!! Form::text('name',old('name'),['class'=>'form-control', 'placeholder'=>'Nombre', 'required' => 'required']) !!}
                </div>

                <div class="form-group">
                    {!! Form::label('hour', __('generics.hour')) !!}
                    {!! Form::number('hour', old('hour'), ['class'=>'form-control', 'placeholder'=>'Horas', 'required' => 'required', 'min'=>1,'max'=>10000]) !!}
                </div>
