                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-3 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <b class="text-danger">*</b>
                                    {!! Form::select('country_code', $countries, old('nationality'), ['class'=>'form-control', 'placeholder'=>__('generics.nationality'), 'required' => 'required']) !!}
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-6">
                                <div class="form-group">
                            ...
                            <div class="col-xl-3 col-lg-6">
                                <div class="form-group">
                                    ...
                                    {!! Form::text('agency',null,['class'=>'form-control', 'placeholder'=>__('generics.agency'),'disabled'=>true]) !!}
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-xl-3 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <b class="text-danger">*</b>
                                    {!! Form::select('country_id', $countries, old('country_id'), ['class'=>'form-control', 'placeholder'=>__('generics.country_id'), 'required' => 'required']) !!}
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <b class="text-danger">*</b>
                                    {!! Form::select('city_id', $cities, old('city_id'), ['class'=>'form-control', 'placeholder'=>__('generics.city'), 'required' => 'required']) !!}
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-6">
                                <div class="form-group">
