        ...
        <div class="content content-full">
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                <h1 class="flex-sm-fill h3 my-2">
                    ...
                    <small class="d-block d-sm-inline-block mt-2 mt-sm-0 font-size-base font-w400 text-muted">Pendientes</small>
                </h1>

                    <a href="{{ route('monetary_requests.historic') }}">
                        <button type="button" class="btn btn-smirrow">Histórico</button>
                    </a>
    ...
    <script>
        $(document).ready(function () {
            $('#monetary_requests-table').DataTable({
                ...
                processing: true,
                responsive: true,
                ajax: "{{ route('monetary_requests.get_list_data_tables') }}",
                columns: [
                    {name: 'id'},
                    {name: 'offeror.name'},
                    {name: 'amount'},
