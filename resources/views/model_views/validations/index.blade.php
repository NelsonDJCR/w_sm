                                ...
                                <tr>
                                    <td class="text-center" scope="row">
                                        @if ($stateValidate == null)
                                            <i class="fa fa-2x fa-info text-danger" data-toggle="tooltip"
                                        ...
                                        @else
                                            ...
                                            @if ($stateValidate->state == 2)
                                                <i class="fa fa-2x fa-file-signature text-danger" data-toggle="tooltip"
                                                    data-placement="right" title="@lang('messages.process_document')"></i>
                                            @endif
                                            @if ($stateValidate->state == 3)
                                                <i class="fa fa-2x fa-check-circle text-dark" data-toggle="tooltip"
                                    ...
                                    <td class="text-center">
                                        @if ($stateValidate == null)
                                            <div class="btn-group">
                                                <a href="{{ route('validations.create', $document->id) }}"
                                                    class="text-danger"> <i class="fa fa-2x fa-upload" data-toggle="tooltip"
                                                        data-placement="left"
                                                        title="@lang('messages.upload_document')"></i></a>
                                            </div>
                                        @else
                                            @if ($stateValidate->state == 1)
                                                <a href="{{ route('validations.edit', $stateValidate->id) }}"
                                                    class="text-danger"> <i class="fa fa-2x fa-upload" data-toggle="tooltip"
                                                        data-placement="left"
                                                        title="@lang('messages.upload_document')"></i></a>
                                            @endif
        ...
        $('.btn-delete-account').click(function() {
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    .then(function(){ window.location = 'https://www.smirrow.com/logout'; });;
                    return false;
                }
            });
        });
