    ...
    <div class="content">
        ...
        <div class="block">
            <div class="block-header">
                <h3 class="block-title">Editar país</h3>
            </div>
            ...
            <div class="block-content">
                ...
                {!! Form::open(['route'=>['countries.update', $country], 'method'=>'PUT', 'role' => 'form']) !!}
                <div class="form-group">
                    {!! Form::label('name',  __('generics.name')) !!}
                    {!! Form::text('name',$country->name,['class'=>'form-control', 'placeholder'=>'Nombre del pais', 'required' => 'required']) !!}
                </div>
                <div class="form-group">
                    {!! Form::label('country_code', __('generics.country_code')) !!}
                    {!! Form::text('country_code',$country->country_code,['class'=>'form-control', 'placeholder'=>'Paìs', 'required' => 'required']) !!}
                </div>

                <div class="form-group">
                    {!! Form::label('language', __('generics.language')) !!}
                    {!! Form::text('language',$country->language,['class'=>'form-control', 'placeholder'=>'Descripción']) !!}
                </div>

                <div class="custom-control custom-switch custom-control-lg mb-2">
                    {!! Form::checkbox('state',old('state'),$country->state, ['class'=>'custom-control-input', 'id'=>'state']) !!}
