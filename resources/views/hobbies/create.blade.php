                ...
                <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-alt">
                        ...
                        <li class="breadcrumb-item" aria-current="page">
                            <a class="link-fx" href="">Pasatiempo</a>
                        </li>
                    </ol>
                </nav>
            </div>
    ...
    <div class="content">
        ...
        <div class="block">
            <div class="block-header">
                <h3 class="block-title">Crear Pasatiempo</h3>
            </div>

            <div class="block-content">
                {!! Form::open(['route'=>'hobbies.store', 'method'=>'POST', 'role' => 'form']) !!}
                    <div class="form-group">
                        {!! Form::label('name', __('generics.name')) !!}
                        {!! Form::text('name',old('name'),['class'=>'form-control', 'placeholder'=>'Nombre del pasatiempo', 'required' => 'required']) !!}
                    </div>
