            ...
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                ...
                <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-alt">
                        <li class="breadcrumb-item">@lang('generics.currencies')</li>
                        <li class="breadcrumb-item" aria-current="page">
                            <a class="link-fx" href="{{route('currencies.index')}}">index</a>
                        </li>
                    </ol>
                </nav>
            </div>
    ...
    <div class="content">
        ...
        <div class="block">
            <div class="block-header">
                <h3 class="block-title">Listado @lang('generics.currencies')</h3>
                <div class="col-md-3 ml-auto text-right" style="padding: 1% 0;">
                    <a href="{{ route('currencies.create') }}">
                        <button type="button" class="btn btn-smirrow">{{__('buttons.create')}}</button> </a>
                </div>
            </div>
            ...
            <div class="block-content">
                <table class="table table-vcenter" id="currencies-table">
                    <thead>
                    <tr>
                        <th>@lang('generics.code')</th>
    ...
    <script>
        $(document).ready(function () {
            $('#currencies-table').DataTable({
                ...
                processing: true,
                responsive: true,
                ajax: "{{ route('currencies.get_list_data_tables') }}",
                columns: [
                    {name: 'code'},
                    {name: 'name'},
                    {name: 'description'},
