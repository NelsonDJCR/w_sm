            ...
            <div class="block">
                ...
                <div class="block-content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-lg-6">
                            <div class="form-group">
                                {!! Form::label('phone_emergeny', __('generics.phone_emergeny')) !!}
                                {!! Form::text('phone_emergeny',$offeror->phone_emergeny,['class'=>'form-control', 'placeholder'=>__('generics.phone')]) !!}
                            </div>
                        </div>
                        <div class="col-xl-3 col-lg-6">
                            <div class="form-group">
                        ...
                        <div class="col-xl-3 col-lg-6">
                            <div class="form-group">
                                ...
                                {!! Form::text('agency',$offeror->agency,['class'=>'form-control d-none', 'placeholder'=>__('generics.agency')]) !!}
                            </div>
                        </div>
                    </div>
