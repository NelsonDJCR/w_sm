    ...
    <div class="content">
        ...
        <div class="block">
            <div class="block-header">
                <h3 class="block-title">Editar @lang('generics.aptitudes')</h3>
            </div>

            <div class="block-content">
                {!! Form::open(['route'=>['aptitudes.update', $aptitude->id], 'method'=>'PUT', 'role' => 'form']) !!}
                    <div class="form-group">
                        {!! Form::label('name', __('generics.name')) !!}
                        {!! Form::text('name', $aptitude->name,['class'=>'form-control', 'placeholder'=>'Nombre de la aptitud', 'required' => 'required']) !!}
                    </div>
