...
<div class="dropdown d-inline-block ml-2" >
    <button type="button" class="btn btn-sm btn-dual" id="page-header-user-dropdown" style="background: #E71C79;border:1px solid #E71C79" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
    ...
    <div class="dropdown-menu dropdown-menu-right p-0 border-0 font-size-sm "  aria-labelledby="page-header-user-dropdown">
        <div class="p-3 text-center bg-smirrow" >
        ...
        <div class="p-2">
            ...
            <div class="dropdown-item d-flex align-items-center  justify-content-between">
                <span class="text-smirrow">{{__('generics.currency')}}</span>
                <span class="badge badge-primary ">{{session('currency')}}</span>
                <a href="#" data-toggle="modal" class="text-smirrow" data-target="#change-currency">{{__('buttons.change')}}</a>
            </div>
            <div role="separator" class="dropdown-divider"></div>
            <h5 class="dropdown-header text-uppercase text-smirrow">{{__('generics.actions')}}</h5>
            ...
            <a class="dropdown-item d-flex align-items-center justify-content-between" href="{{route('change_password')}}">
